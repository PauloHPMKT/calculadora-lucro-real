...
export const TaxationCalc = ({ receiveCompra }) => {
    ...
    }, [receiveCompra, ipiPercent, frightPercent, icmsPercent, reductionPercent, pisConfinsPercent, retencaoPercent, reductionValue, icmsValue, pisConfinsValue, retencaoValue]);
    ...
    const handleChangeIcmsPercent = (e) => {
        ...
        setReductionValue(calcDiscount(calcTax(receiveCompra, percent), reductionPercent));
    }
    ...
    // const totalCustoCompra = calcCustoDeCompra();
    // onCostCompra(totalCustoCompra);
    ...
    return (
        <div>  
            ...
            <div>
                <div>
                    <div style={{ width: "100%", textAlign: "center", border: "1px solid" }}>
                        <h2>Compra</h2>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ border: "1px solid", width: "33.3%" }}>Tributação</div>
                        <div style={{ border: "1px solid", width: "33.3%" }}>Percentual</div>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ border: "1px solid", width: "33.3%" }}>PIS/CONFINS</div>
                        <div style={{ border: "1px solid", width: "33.3%" }}>
                            <input 
                                type="text" 
